...
//            print_r($allCategories);exit;
        ...
        return $this->fetch('article/category_list');
    }
...
//        echo $field;
    ...
    {
        extract(input());
        $menu = new ArticleCategoryModel();
        $flag = $menu->statusState($id,$num);
        return json(['code' => $flag['code'], 'data' => $flag['data'], 'msg' => $flag['msg']]);
    }
...
//            print_r($param);exit;
        ...
        $category = Db::name('article_category')->where('category_id',$category_id)->find();
